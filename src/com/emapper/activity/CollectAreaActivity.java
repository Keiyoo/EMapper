 ...
 * 
 */
public class CollectAreaActivity extends BaseActivity implements OnClickListener {
	...
	private void initView(){
		setContentView(R.layout.activity_collect_area);
		TextView text_title = (TextView) findViewById(R.id.tv_title);
		text_title.setText(getString(R.string.title_activity_collect_area));
